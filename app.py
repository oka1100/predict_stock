...
st.write('あくまで予測の練習です')

st.header("ティッカーシンボルを入力")
stock_name = st.text_input("例：AAPL","AAPL")
...
st.markdown(link)
st.write('ティッカーシンボルについては上のリンクをご参照下さい')
...
st.header(stock_name_full + '1か月後を予想しよう　(USD)')
def stock_predict():
